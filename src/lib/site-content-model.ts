...
export function getProjectSlug(item: FeaturedWorkItem): string {
  ...
  featuredWork: [
    {
      ...
      details:
        "A premium portfolio experience designed to feel editorial, fast, and easy to evolve as the agency grew. The project combined a refined visual language with modular CMS-driven content blocks and a smooth browsing experience across desktop and mobile.",
    },
    {
      ...
      details:
        "The redesign focused on simplifying the core user journey, clarifying product data, and making the first-run experience more intuitive. The result was a cleaner interface and stronger adoption from new users.",
    },
  ],
  experienceData: [
    {
